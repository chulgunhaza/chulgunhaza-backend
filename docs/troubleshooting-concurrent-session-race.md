...
**2. 원래 재현 절차(동시 요청 5개)를 10회 반복, 총 50개 요청**:

```
run 1: [200,200,200,200,200]  실패:0
run 2: [200,200,200,200,200]  실패:0
run 3: [200,200,200,200,200]  실패:0
run 4: [200,200,200,200,200]  실패:0
run 5: [200,200,200,200,200]  실패:0
run 6: [200,200,200,200,200]  실패:0
run 7: [200,200,200,200,200]  실패:0
run 8: [200,200,200,200,200]  실패:0
run 9: [200,200,200,200,200]  실패:0
run 10: [200,200,200,200,200]  실패:0
=== 총 실패: 0 / 50 ===
```

백엔드 로그에도 `IllegalStateException`/`ERROR` 0건. **애초에 세션 ID가 안 바뀌니
`hasKey()` 경합이 발생할 조건 자체가 사라졌다.**
